<?php
	...
	function Notify() {
		...
		@CDbShell::connect();
		CDbShell::query("SELECT F.*, L.PaymentName, L.MerTradeID, L.MerProductID, L.MerUserID, L.Total, L.Fee FROM Ledger AS L INNER JOIN Firm AS F ON L.FirmSno = F.Sno WHERE L.Sno = '".$xml->USERDATA1."'"); 
